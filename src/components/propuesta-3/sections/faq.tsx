          ...
          {items.map((item, i) => {
            ...
            return (
              <div key={item.q} className="border-b border-rule/10">
                ...
                {/* Acordeón deliberadamente sin gracia: una sola transición
                    uniforme para altura y opacidad, misma curva y misma
                    duración al abrir y al cerrar. Las versiones anteriores
                    escalonaban ambas propiedades y usaban curvas expresivas,
                    y eso —por corto que fuera— se percibía como un retardo
                    antes de que el panel respondiera. Aquí el panel sigue al
                    dedo: es un control, no una pieza de coreografía. */}
